\hypertarget{cache__storage_8c}{}\doxysection{/mnt/c/\+Users/zenj2/\+L\+I\+R\+S-\/cache/source/cache\+\_\+storage.c File Reference}
\label{cache__storage_8c}\index{/mnt/c/Users/zenj2/LIRS-\/cache/source/cache\_storage.c@{/mnt/c/Users/zenj2/LIRS-\/cache/source/cache\_storage.c}}
...
\begin{DoxyCompactItemize}
\item 
static void $\ast$ \mbox{\hyperlink{cache__storage_8c_ae6bacc13fa57863173e3bd54019343c3}{cache\+\_\+unit\+\_\+pointer}} (struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$cachestorage, int cacheunitindex)
\item 
static void \mbox{\hyperlink{cache__storage_8c_ab591ed532817c23c5a30242f6bfbf87a}{cache\+\_\+unit\+\_\+clear}} (struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$cachestorage, void $\ast$cacheunit)
\item 
struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$ \mbox{\hyperlink{cache__storage_8c_ab52fa9bb2b1fc4ae7a08623a885a5d96}{cache\+\_\+storage\+\_\+init}} (int capacity, int unitsize, \mbox{\hyperlink{lirs_8h_a7bb10de407c090d61acfd51ff0d42892}{fgetdata\+\_\+t}} \mbox{\hyperlink{tester_8c_a230451480887ca801843563a11c2c106}{fgetdata}})
...
\item 
void $\ast$ \mbox{\hyperlink{cache__storage_8c_ad5f9b031cf13847e3052a0d5eb4893d8}{cache\+\_\+unit\+\_\+add}} (struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$cachestorage, int filenumber)
\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{cache__storage_8c_ab52fa9bb2b1fc4ae7a08623a885a5d96}\label{cache__storage_8c_ab52fa9bb2b1fc4ae7a08623a885a5d96}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{cache__storage_8c_ad5f9b031cf13847e3052a0d5eb4893d8}\label{cache__storage_8c_ad5f9b031cf13847e3052a0d5eb4893d8}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{cache__storage_8c_ab591ed532817c23c5a30242f6bfbf87a}\label{cache__storage_8c_ab591ed532817c23c5a30242f6bfbf87a}} 
\index{cache\_storage.c@{cache\_storage.c}!cache\_unit\_clear@{cache\_unit\_clear}}
\index{cache\_unit\_clear@{cache\_unit\_clear}!cache\_storage.c@{cache\_storage.c}}
\doxysubsubsection{\texorpdfstring{cache\_unit\_clear()}{cache\_unit\_clear()}}
{\footnotesize\ttfamily static void cache\+\_\+unit\+\_\+clear (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$}]{cachestorage,  }\item[{void $\ast$}]{cacheunit }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}

The function that delete the data of the cache unit by its pointer and writes zeros to it. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em cachestorage} & The pointer on the \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} object where you need to clear cache unit. \\
\hline
\mbox{\texttt{ out}}  & {\em cacheunit} & The pointer on the cache unit that you need to clear. \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{cache__storage_8c_ae6bacc13fa57863173e3bd54019343c3}\label{cache__storage_8c_ae6bacc13fa57863173e3bd54019343c3}} 
\index{cache\_storage.c@{cache\_storage.c}!cache\_unit\_pointer@{cache\_unit\_pointer}}
\index{cache\_unit\_pointer@{cache\_unit\_pointer}!cache\_storage.c@{cache\_storage.c}}
\doxysubsubsection{\texorpdfstring{cache\_unit\_pointer()}{cache\_unit\_pointer()}}
{\footnotesize\ttfamily static void $\ast$ cache\+\_\+unit\+\_\+pointer (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} $\ast$}]{cachestorage,  }\item[{int}]{cacheunitindex }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}

The function that gives the pointer on the cache unit with current index. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em cachestorage} & The pointer on the \mbox{\hyperlink{structcache__storage__t}{cache\+\_\+storage\+\_\+t}} object where you find cache unit. \\
\hline
\mbox{\texttt{ in}}  & {\em cacheunitindex} & The index of the cache unit that you find. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The pointer on the cache unit with current index. 
\end{DoxyReturn}
